...
This project includes 6 custom Skills that activate automatically based on context:

- **codebase-analysis**: Discover patterns, conventions, and architecture
- **architectural-planning**: Design solutions aligned with existing structure
- **code-implementation**: Write code matching project style
- **code-quality**: Safe refactoring and performance optimization
- **security-review**: Vulnerability detection and security analysis
